...
<html lang="en">
  <head>
    ...
    <title>
      Aplikasi Forecasting Apotek nella vernanda naibaho | 
      <?php 
        if(@$_GET['page']=='') {
          echo "Dashboard";
  ...
  <body class="bg-light">
  	...
  	<div class="col-md-12 bg-info p-1 title">
  		...
  		<div class="row">
  			<div class="col-md-6">
  				<span class="text-white font-weight-light">Aplikasi Sale Forecasting - Apotek NELLA VERNANDA NAIBAHO</span>
  			</div>
  	...
  	<footer>
  		<i class="fas fa-copyright"></i> Nella Vernanda Naibaho / 12030122120041 (FEB Universitas Diponegoro)
  	</footer>
    <!-- Optional JavaScript -->
