...
<script>
	$("button[name='tombol_hapus']").click(function() {
		...
		if(id==id_session) {
			Swal.fire({
	          title: 'BERMASALAH !',
	          text: 'TIDAK BISA MENGHAPUS DATA ANDA SENDRI',
	          type: 'error',
			...
			Swal.fire({
	          ...
	          text: 'hapus data '+nama+',datayang sudah dihapus tidak dapat dipulihakan dan semua data transaksi yang berkaitan dengan pegawai ini akan ikut terhapus',
	          type: 'warning',
