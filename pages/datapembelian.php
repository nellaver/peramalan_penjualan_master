...
<script>
	...
	$("button[name='tombol_hapus']").click(function() {
		...
		Swal.fire({
          ...
          text: 'hapus data pembelian '+no_faktur+', data yang sudah dihapus tidak dapat dipulihkan.',
          type: 'warning',
          showCancelButton: true,
          cancelButtonColor: '#cb260f',
    ...
    $("button[name='tombol_pelunasan']").click(function() {
        ...
        Swal.fire({
          title: 'anda yakin dengan pilihan anda?',
          text: 'anda telah melunasi pembelian '+no_faktur+' dengan pihak '+nama_supp+', data ini tidak dapat dirubah kembali, periksa kembali data anda.',
          type: 'warning',
          showCancelButton: true,
