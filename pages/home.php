...
<div class="page-content">
	<div>
		<div class="col-12"><h5> WELLCOME,CAN I HELP YOU? <?php echo $_SESSION['nama_peg']; ?></h5></div>
	</div>
	<style>
		h6 {
			font-size: 25px;
	...
	<div class="konten-home" style="margin-top: 70px;">
		<div class="row" style="margin-bottom: 18px;">
			<div class="col-lg-6">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #fdf59a;">
			      <div class="card-body" style="padding: 40px 20px;">
			        <h6 class="card-title">Total Penjualan Hari ini</h6>
			        <div class="card-text" align="right" style="font-size: 37px; font-weight: lighter;">
			...
			<div class="col-lg-6">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #DC3545;">
			      <div class="card-body" style="padding: 40px 20px;">
		...
		<div class="row" style="margin-bottom: 18px;">
			<div class="col-lg-6">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #ffc107;">
			      <div class="card-body" style="padding: 40px 20px;">
			...
			<div class="col-lg-3">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #17A2B8;">
			...
			<div class="col-lg-3">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #cb2929;">
			      <div class="card-body" style="padding: 40px 20px;">
		...
		<div class="row" style="margin-bottom: 18px;">
			<div class="col-lg-6">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #20c997;">
			      <div class="card-body" style="padding: 40px 20px;">
			...
			<div class="col-lg-6">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #fd7e14;">
			      <div class="card-body" style="padding: 40px 20px;">
		...
		<div class="row" style="margin-bottom: 18px;">
			<div class="col-lg-4">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #E83E9C;">
			      <div class="card-body" style="padding: 40px 20px;">
			...
			<div class="col-lg-4">
				<?php 
				 ...
				 ?>
				<div class="card text-BLACK" style="background-color: #007BFF;">
			      <div class="card-body" style="padding: 40px 20px;">
